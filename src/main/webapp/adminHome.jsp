...
<div class="headerDiv">
  ...
  <div>
	...
	<div>
		...
		<div style="float: left; width: 25%;">
			<img src="${pageContext.request.contextPath}/images/logo/pet_item.png" width= 94%/>
			
			<center>
				<form action="spareParts" method="post">
					<input class="homeButton" style="vertical-align:middle; width: 300px; font-size: 20px;" type="submit" name="submit" value="Pet Items Management">
				</form>
			</center>
