...
<div class="headerDiv">
  ...
  <div>
	...
	<h1 style="text-align: center; color: #143d59; background-color:#f4b41a; font-family: 'Verdana', Sans-serif;">Pet Items Database Records</h1>
	...
	<a href="InsertSparePart.jsp">
		<button style="margin-right: 0px; float: right" class="simp2button">Insert Pet Item</button>
	</a><br><br><br><br>
		...
		<c:forEach var="spare" items="${sparePart}">
			...
			<tr class="sTr">
				...
				<td class="sTd"><c:url value="updateSpareParts.jsp"
					...
					</c:url>  <a href="${sparePartUpdate}"> 
					<input type="button" name="update" value="Update Spare Part Details" class="sUpdatebttn">
				</a></td>
				<td class="sTd"><c:url value="deleteSpareParts.jsp" var="sparePartDelete"> 
						<c:param name="id" value="${partId}" /> 
						<c:param name="category" value="${category}" />
						<c:param name="partName" value="${partName}" />
						<c:param name="qty" value="${qty}" />
