...
<!--  HEADER -->
	...
	<div>
		...
		<div style="float: right; width: 50%;">
			<img src="${pageContext.request.contextPath}/images/logo/excellentServices.png"/>
		</div>
	
		<div style="font-size: 100px; color: white; width: 50%;"
		><b>"Explore our<br> 
		&nbsp excellent Pet Care<br> 
		 services"</b>
		<br>
		<center>
		...
		<div style="width: 50%;">
			<img src="${pageContext.request.contextPath}/images/logo/serviceManagement.png"/>
		</div>
		<br>
		<br>
		<br>
